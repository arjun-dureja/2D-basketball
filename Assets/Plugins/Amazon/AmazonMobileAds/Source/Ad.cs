    ...
    public sealed class Ad : Jsonable
    {
        ...
        public override Dictionary<string, object> GetObjectDictionary() 
        {
            try 
            {
                ...
                objectDictionary.Add("adType", AdType);
                objectDictionary.Add("identifier", Identifier);
        ...
        {
            Dictionary<string, Ad> result = new Dictionary<string, Ad>();
            foreach (var entry in jsonMap)
            {
                Ad value = CreateFromDictionary(entry.Value as Dictionary<string, object>);
