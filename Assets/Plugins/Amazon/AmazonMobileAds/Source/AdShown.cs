...
namespace com.amazon.mas.cpt.ads
{
    public sealed class AdShown : Jsonable
    {
        ...
        {
            Dictionary<string, AdShown> result = new Dictionary<string, AdShown>();
            foreach (var entry in jsonMap)
            {
                AdShown value = CreateFromDictionary(entry.Value as Dictionary<string, object>);
        ...
        {
            List<AdShown> result = new List<AdShown>();
